...
function makeLineChart(dataset, xName, yNames, annotations) {
    ...
    chart.formatAsDay = d3.timeFormat("%m/%d/%Y");
    ...
    function prepareData() {
        ...
        for (yName in chart.yNames) {
            ...
            chartY.visible = !chart.yNames[yName].visible ; 
    ...
    chart.update = function () {
        ...
        chart.yScale.range([chart.height, 0.5]).domain([0.5, getYMax()]);
